...
def words_loss(img_features, words_emb, labels,
    ...
    for i in range(batch_size):
        ...
        # --> 1 x batch_size
        # similarities(i, j): the similarity between the i-th image and the
...
def discriminator_loss(netD, real_imgs, fake_imgs, conditions, real_labels,
    ...
    #### comparing logits of real/fake images with corresponding labels
...
def generator_loss(netsD, image_encoder, fake_imgs, real_labels, words_embs,
    ...
    for i in range(numDs):
        ...
        if i == (numDs -1):
            ...
            s_loss = (s_loss + s_loss1) * cfg.TRAIN.SMOOTH.LAMBDA
